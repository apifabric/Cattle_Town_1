...
resourcename="cattletown1"  # lower case, only
resourcegroup="cattletown1_rg"
...
# git clone https://github.com/apilogicserver/cattletown1.git
# cd cattletown1
...
az group create --name cattletown1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group cattletown1_rg --sku S1 --is-linux
az container create --resource-group cattletown1_rg --name cattletown1 --image apilogicserver/cattletown1:latest --dns-name-label cattletown1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//cattletown1.westus.azurecontainer.io:5656'
