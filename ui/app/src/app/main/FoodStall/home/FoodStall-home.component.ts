...
@Component({
  selector: 'FoodStall-home',
  templateUrl: './FoodStall-home.component.html',
  styleUrls: ['./FoodStall-home.component.scss']
})
export class FoodStallHomeComponent implements AfterViewInit {
