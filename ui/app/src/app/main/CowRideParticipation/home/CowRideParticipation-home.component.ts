...
@Component({
  selector: 'CowRideParticipation-home',
  templateUrl: './CowRideParticipation-home.component.html',
  styleUrls: ['./CowRideParticipation-home.component.scss']
})
export class CowRideParticipationHomeComponent implements AfterViewInit {
