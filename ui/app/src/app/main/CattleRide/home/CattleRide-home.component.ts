...
@Component({
  selector: 'CattleRide-home',
  templateUrl: './CattleRide-home.component.html',
  styleUrls: ['./CattleRide-home.component.scss']
})
export class CattleRideHomeComponent implements AfterViewInit {
