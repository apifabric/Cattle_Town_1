...
@Component({
  selector: 'GamblingAttraction-home',
  templateUrl: './GamblingAttraction-home.component.html',
  styleUrls: ['./GamblingAttraction-home.component.scss']
})
export class GamblingAttractionHomeComponent implements AfterViewInit {
