...
@Component({
  selector: 'AmusementPark-home',
  templateUrl: './AmusementPark-home.component.html',
  styleUrls: ['./AmusementPark-home.component.scss']
})
export class AmusementParkHomeComponent implements AfterViewInit {
