...
@Component({
  selector: 'ParkVisitor-home',
  templateUrl: './ParkVisitor-home.component.html',
  styleUrls: ['./ParkVisitor-home.component.scss']
})
export class ParkVisitorHomeComponent implements AfterViewInit {
