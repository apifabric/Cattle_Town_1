...
@Component({
  selector: 'MedicalTreatment-home',
  templateUrl: './MedicalTreatment-home.component.html',
  styleUrls: ['./MedicalTreatment-home.component.scss']
})
export class MedicalTreatmentHomeComponent implements AfterViewInit {
